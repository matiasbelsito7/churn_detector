...
GRID_SEARCH_JSON = PROJECT_ROOT / "reports" / "grid_search.json"
GRID_SEARCH_MD = PROJECT_ROOT / "reports" / "grid_search.md"
EXPLORE_HP_JSON = PROJECT_ROOT / "reports" / "hyperparams_exploration.json"
EXPLORE_HP_MD = PROJECT_ROOT / "reports" / "hyperparams_exploration.md"
SELECTION_JSON = PROJECT_ROOT / "reports" / "selection.json"
SELECTION_MD = PROJECT_ROOT / "reports" / "selection.md"
ADOPTION_JSON = PROJECT_ROOT / "reports" / "adoption.json"
ADOPTION_MD = PROJECT_ROOT / "reports" / "adoption.md"
...
EXPLAINABILITY_MD = PROJECT_ROOT / "reports" / "explainability.md"
EXPLAINABILITY_JSON = PROJECT_ROOT / "reports" / "explainability.json"
