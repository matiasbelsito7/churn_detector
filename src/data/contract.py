...
SPECS: dict[str, FieldSpec] = {
    ...
    for spec in (
        ...
        FieldSpec(
            "gender", "category", ("Female", "Male"), description="Género del cliente."
        ),
        FieldSpec(
            "SeniorCitizen",
            "int",
            minimum=0,
            maximum=1,
            description="1 si adulto mayor, 0 si no.",
        ),
        ...
        FieldSpec(
            ...
            "category",
            ("No", "Yes"),
            description="Tiene personas a cargo.",
        ),
        FieldSpec(
            "tenure", "int", minimum=0, maximum=72, description="Meses de antigüedad."
        ),
        FieldSpec(
            "PhoneService",
            "category",
        ...
        FieldSpec(
            ...
            description="Seguridad online.",
        ),
        FieldSpec(
            "OnlineBackup",
            "category",
            ("No", "No internet service", "Yes"),
            description="Respaldo online.",
        ),
        FieldSpec(
            "DeviceProtection",
            "category",
            ("No", "No internet service", "Yes"),
            description="Protección de dispositivo.",
        ),
        FieldSpec(
            "TechSupport",
            "category",
        ...
        FieldSpec(
            ...
            "category",
            ("No", "Yes"),
            description="Facturación sin papel.",
        ),
        FieldSpec(
            "PaymentMethod",
            "category",
        ...
        FieldSpec(
            ...
            minimum=0.0,
            nullable=True,
            description="Cargo total acumulado; ausente si tenure == 0.",
        ),
        FieldSpec(
            TARGET,
            "target",
            ("No", "Yes"),
            description="Target: abandonó el servicio (Yes).",
        ),
    )
}
